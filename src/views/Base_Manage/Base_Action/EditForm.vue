...
export default {
  ...
  methods: {
    ...
    openForm(id) {
      ...
      if (id) {
        this.$http.post('/Base_Manage/Base_Action/GetBase_Action', { id: id }).then(resJson => {
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.$http.post('/Base_Manage/Base_Action/SaveBase_Action', this.entity).then(resJson => {
