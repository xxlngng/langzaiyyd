  ...
  >
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        ...
        <a-form-model-item label="消息来源" prop="MsgFrom">
          <a-input v-model="entity.MsgFrom" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="发送时间" prop="SendTime">
          <a-input v-model="entity.SendTime" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="接收对象" prop="AcceptObject">
          <a-input v-model="entity.AcceptObject" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="发送是否成功" prop="Status">
          <a-input v-model="entity.Status" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="返回状态码" prop="Code">
...
export default {
  ...
  methods: {
    ...
    openForm(id, title) {
      ...
      if (id) {
        this.loading = true
        this.$http.post('/Data_Manage/Data_Msg_Log/GetTheData', { id: id }).then(resJson => {
          this.loading = false
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.loading = true
        this.$http.post('/Data_Manage/Data_Msg_Log/SaveData', this.entity).then(resJson => {
          this.loading = false
