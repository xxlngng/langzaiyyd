    ...
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        ...
        <a-form-model-item label="序号" prop="OrderNum">
          <a-input v-model="entity.OrderNum" autocomplete="off" />
        </a-form-model-item>
...
export default {
  ...
  methods: {
    ...
    openForm(id, title) {
      ...
      if (id) {
        this.loading = true
        this.$http.post('/Data_Manage/Data_Rule_Config/GetTheData', { id: id }).then(resJson => {
          this.loading = false
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.loading = true
        this.$http.post('/Data_Manage/Data_Rule_Config/SaveData', this.entity).then(resJson => {
          this.loading = false
