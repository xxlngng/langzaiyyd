          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="OrderNum">序号</a-select-option>
                <a-select-option key="Name">名称</a-select-option>
                <a-select-option key="Weight">权重值</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="24">
...
const columns = [
  ...
  { title: '序号', dataIndex: 'OrderNum', width: '10%' },
  { title: '名称', dataIndex: 'Name', width: '10%' },
  { title: '权重值', dataIndex: 'Weight', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/Data_Manage/Data_Rule_Config/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Data_Manage/Data_Rule_Config/DeleteData', ids).then(resJson => {
              resolve()
