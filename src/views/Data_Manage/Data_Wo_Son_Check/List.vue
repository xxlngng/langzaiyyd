          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="PlanName">计划名称</a-select-option>
                <a-select-option key="Major">专业</a-select-option>
...
const columns = [
  ...
  { title: '计划名称', dataIndex: 'PlanName', width: '10%' },
  { title: '专业', dataIndex: 'Major', width: '10%' },
  { title: '计划执行时间', dataIndex: 'ExecuteTime', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/Data_Manage/Data_Wo_Son_Check/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Data_Manage/Data_Wo_Son_Check/DeleteData', ids).then(resJson => {
              resolve()
