          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                ...
                <a-select-option key="SiteCode">站址编码</a-select-option>
                <a-select-option key="FaultInfo">故障原因</a-select-option>
                ...
                <a-select-option key="HandleMan">处理人员</a-select-option>
...
const columns = [
  ...
  { title: '站址编码', dataIndex: 'SiteCode', width: '10%' },
  { title: '故障原因', dataIndex: 'FaultInfo', width: '10%' },
  ...
  { title: '处理人员', dataIndex: 'HandleMan', width: '10%' },
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.loading = true
      this.$http
        .post('/Data_Manage/Data_Wo_Son_Temp/GetDataList', {
      ...
      this.$confirm({
        ...
        onOk() {
          return new Promise((resolve, reject) => {
            thisObj.$http.post('/Data_Manage/Data_Wo_Son_Temp/DeleteData', ids).then(resJson => {
              resolve()
